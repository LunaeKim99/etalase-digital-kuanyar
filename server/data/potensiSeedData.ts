export interface SeedPotensiCategory {
  slug: string
  title: string
  description: string
  icon: string
...
export interface SeedPotensiItem {
  numId: number
  id: string
  name: string
  description: string
...
export const potensiCategories: SeedPotensiCategory[] = [
  {
    slug: 'konveksi',
    title: 'Konveksi',
...
export const potensiItems: SeedPotensiItem[] = [
  {
    numId: 1,
    id: 'konveksi-1',
    name: 'MYG Collection',
  ...
  },
  {
    ...
    marketplace: 'Pemesanan via WhatsApp',
  },
  {
    numId: 4,
    id: 'konveksi-4',
