...
export const umkms: SeedUmkm[] = [
  // === KONVEKSI ===
  {
    ...
    logo: 'https://picsum.photos/seed/myg-collection/600/400',
    status: 'approved',
  },
  {
    id: 2,
    ...
    logo: 'https://picsum.photos/seed/reza-collection/600/400',
    status: 'approved',
  },
  {
    id: 3,
    ...
    whatsapp: '',
    logo: 'https://picsum.photos/seed/mila-collection/600/400',
    status: 'approved',
  },
  {
    id: 4,
    ...
    address: 'RT 03/RW 02, Desa Kuanyar, Mayong, Jepara',
    whatsapp: '',
    logo: 'https://picsum.photos/seed/mudah-collection/600/400',
    status: 'approved',
  },
  // === KULINER ===
  {
    ...
    logo: 'https://picsum.photos/seed/dahlia-catering/600/400',
    status: 'approved',
  },
  {
    id: 6,
    ...
    logo: 'https://picsum.photos/seed/naning-bakery/600/400',
    status: 'approved',
  },
  {
    id: 7,
    ...
    logo: 'https://picsum.photos/seed/zakya-snack/600/400',
    status: 'approved',
  },
  // === POTENSI LAINNYA ===
  {
...
export const products: SeedProduct[] = [
  // === MYG Collection ===
  {
    ...
    price: 50000,
    image: 'https://picsum.photos/seed/myg-celana-cowok/600/400',
    stock: 200,
    status: 'active',
  },
  {
    ...
    price: 50000,
    image: 'https://picsum.photos/seed/myg-celana-cewek/600/400',
    stock: 200,
    status: 'active',
  },
  // === Reza Collection ===
  {
    ...
    price: 45000,
    image: 'https://picsum.photos/seed/reza-seragam/600/400',
    stock: 100,
    status: 'active',
  },
  {
    ...
    price: 35000,
    image: 'https://picsum.photos/seed/reza-celana-anak/600/400',
    stock: 80,
    status: 'active',
  },
  {
    ...
    price: 60000,
    image: 'https://picsum.photos/seed/reza-celana-dewasa/600/400',
    stock: 60,
    status: 'active',
  },
  // === Mila Collection ===
  {
    ...
    price: 55000,
    image: 'https://picsum.photos/seed/mila-kulot/600/400',
    stock: 150,
    status: 'active',
  },
  {
    ...
    price: 50000,
    image: 'https://picsum.photos/seed/mila-celana/600/400',
    stock: 120,
    status: 'active',
  },
  // === Mudah Collection ===
  {
    ...
    price: 55000,
    image: 'https://picsum.photos/seed/mudah-kulot/600/400',
    stock: 100,
    status: 'active',
  },
  {
    ...
    price: 40000,
    image: 'https://picsum.photos/seed/mudah-pendek/600/400',
    stock: 80,
    status: 'active',
  },
  {
    ...
    price: 65000,
    image: 'https://picsum.photos/seed/mudah-panjang/600/400',
    stock: 70,
    status: 'active',
  },
  // === Dahlia Jaya Catering ===
  {
    ...
    price: 25000,
    image: 'https://picsum.photos/seed/dahlia-nasi-box/600/400',
    stock: 30,
    status: 'active',
  },
  {
    ...
    price: 30000,
    image: 'https://picsum.photos/seed/dahlia-bento/600/400',
    stock: 20,
    status: 'active',
  },
  {
    ...
    price: 20000,
    image: 'https://picsum.photos/seed/dahlia-snack/600/400',
    stock: 25,
    status: 'active',
  },
  // === Naning Bakery ===
  {
    ...
    price: 5000,
    image: 'https://picsum.photos/seed/naning-roti/600/400',
    stock: 100,
    status: 'active',
  },
  {
    ...
    price: 22000,
    image: 'https://picsum.photos/seed/naning-nasi-box/600/400',
    stock: 30,
    status: 'active',
  },
  {
    ...
    price: 40000,
    image: 'https://picsum.photos/seed/naning-kue/600/400',
    stock: 50,
    status: 'active',
  },
  // === Zakya ===
  {
    ...
    price: 15000,
    image: 'https://picsum.photos/seed/zakya-stik-cumi/600/400',
    stock: 40,
    status: 'active',
  },
  {
    ...
    price: 15000,
    image: 'https://picsum.photos/seed/zakya-kuping-gajah/600/400',
    stock: 35,
    status: 'active',
  },
  // === Anyaman Bambu ===
...
export const posts: SeedPost[] = [
  {
    ...
    authorId: 1,
    coverImage: 'https://picsum.photos/seed/kuanyar-konveksi/800/450',
    images: [
      { imageUrl: 'https://picsum.photos/seed/konveksi1/800/450', caption: 'Produksi celana di MYG Collection', sortOrder: 0 },
      { imageUrl: 'https://picsum.photos/seed/konveksi2/800/450', caption: 'Mesin jahit Reza Collection', sortOrder: 1 },
    ],
  },
  {
    id: 2,
    ...
    authorId: 1,
    coverImage: 'https://picsum.photos/seed/kuanyar-kuliner/800/450',
    images: [
      { imageUrl: 'https://picsum.photos/seed/kuliner1/800/450', caption: 'Nasi box ayam bakar Dahlia Jaya', sortOrder: 0 },
      { imageUrl: 'https://picsum.photos/seed/kuliner2/800/450', caption: 'Roti pisang Naning Bakery', sortOrder: 1 },
    ],
  },
  {
    id: 3,
